...
exports.ActivosModule = ActivosModule = __decorate([
    (0, common_1.Module)({ providers: [activos_service_1.ActivosService], controllers: [activos_controller_1.ActivosController], exports: [activos_service_1.ActivosService] })
], ActivosModule);
