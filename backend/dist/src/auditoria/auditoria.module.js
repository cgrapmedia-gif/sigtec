...
exports.AuditoriaModule = AuditoriaModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({ providers: [auditoria_service_1.AuditoriaService], controllers: [auditoria_controller_1.AuditoriaController], exports: [auditoria_service_1.AuditoriaService] })
], AuditoriaModule);
